    ...
    public boolean execute() throws Exception {
        ...
        if (pending != null) {
            if (!pending.equals(clanName)) {
                ...
                if (balance < cost) {
                    throw new CommandException(String.format(Lang.getLang("not_enough_money"), cost));
                }
            ...
            p.sendMessage(String.format(Lang.getLang("clan_create_confirm"), Lang.colorString(clanName), cost));
        }
