...
public class Clans {
    ...
    public static void msgInfo(Clan clan, Player p) {
        ...
        p.sendMessage(String.format(Lang.getLang("clan_size"), clan.clanSize()));
    }
    ...
    public static void msgInfoMember(Clan clan, Player p) {
        ...
        p.sendMessage(String.format(Lang.getLang("clan_size"), clan.clanSize() + "/" + getMaxMembers(clan.getLevel())));
    ...
    public static void sendClanList(CommandSender s, int page) {
        ...
        int i = 0;
        s.sendMessage(Lang.getLang("list_list") + " " + String.format(Lang.getLang("page"), page, maxPages) + ":");
